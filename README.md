...
- **[IPHeader](https://github.com/Maikuolan/Common/blob/v1/_docs/IPHeader.md)**: Attempts to resolve an originating IP address from a preferred source, or `REMOTE_ADDR` if the preferred source isn't available.
