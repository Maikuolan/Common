...
Language (English) | Language (Local) | `IntegerRule` | `FractionRule` | Notes
---|---|---|---|---
...
Bangla/Bengali | বাংলা | `int2Type3` | `fraction2Type2`
German | Deutsch | `int2Type4` | `int1`
English | English | `int2Type4` | `int1`
Spanish | Español | `int2Type4` | `int1`
French | Français | `int2Type3` | `fraction2Type1`
Hindi | हिंदी | `int2Type3` | `fraction2Type2`
Indonesian | Bahasa Indonesia | `int1` | `int1`
Italian | Italiano | `int2Type4` | `int1`
Japanese | 日本語 | `int1` | `int1`
Korean | 한국어 | `int1` | `int1`
Dutch | Nederlandse | `int2Type4` | `int1`
Norwegian | Norsk | `int2Type4` | `int1`
Portuguese | Português | `int2Type4` | `int1` | Pluralisation rules possibly could be different between different dialects (e.g., European vs Brazilian), but I'm not entirely sure.
Russian | Русский | `int3Type4` | `int1`
Swedish | Svenska | `int2Type4` | `int1`
Thai | ไทย | `int1` | `int1`
Turkish | Türkçe | `int2Type4` | `int1`
Urdu | ‏اردو‏ | `int2Type4` | `int1`
Vietnamese | Tiếng Việt | `int1` | `int1`
Chinese | 中文 | `int1` | `int1` | Whether simplified or traditional (傳統/简体), pluralisation rules are the same.
